...
export default function Checkout() {
  ...
  console.log("handleSubscription: rzorpayKey =", rzorpayKey);
  console.log("handleSubscription: subscription_id =", subscription_id);
  async function handleSubscription(e) {
    e.preventDefault();
    if (!rzorpayKey || !subscription_id) {
      toast.error("something went wrong/KeyIds not ready yet");
      return;
    }
    ...
    const options = {
      ...
      amount: 49900, // Amount in smallest currency unit (paise for INR). 499 Rs * 100 = 49900
      currency: "INR",
      theme: {
        color: "#fff",
      },
      prefill: {
        ...
        contact: userData?.contact || "9876543210" // ADD THIS LINE. Use user's contact if available, else a dummy test number
      },
